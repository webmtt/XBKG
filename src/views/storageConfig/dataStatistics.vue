  ...
  <div class="app-container">
    ...
    <el-form class="searchContent" v-show="is_show == true">
      <el-form-item>
        ...
        <el-radio v-model="radio" label="2">年</el-radio>
      </el-form-item>
      <el-form-item label="日期范围：" style="min-width:382px;">
        <el-date-picker
          style="width:300px"
          v-model="timeScope"
          type="datetimerange"
...
import AdvancedFilter from '@/views/application/components/aviationMessage'
import {
...
export default {
  components: { Pagination, AdvancedFilter },
  props: {
    fatherHeight: {
      type: Number,
      default: 0
  ...
  data() {
    return {
      ...
      tableMeta: [
        { key: 'YYGGgg', label: '时间' },
        { key: 'CCCC', label: '机场名称' },
        { key: 'fff', label: '风速(m/s)' },
        { key: 'SSTTT', label: '温度(℃)' },
        { key: 'Shhh', label: '飞行高度(m)' },
        { key: 'UUU', label: '湿度' }
      ],
      listQuery: {
        page: 1,
  ...
  methods: {
    initEcharts() {
      ...
      dataMap.dataGDP = dataFormatter({
        ...
        2002: [4315, 2150.76, 6018.28, 2324.8, 1940.94, 5458.22]
      })
        ...
        options: [
          {
            ...
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2002sum'] },
                  { name: '常规观测', value: dataMap.dataSI['2002sum'] },
                  { name: '非常规观测', value: dataMap.dataTI['2002sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2003历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2003sum'] },
                  { name: '常规观测', value: dataMap.dataSI['2003sum'] },
                  { name: '非常规观测', value: dataMap.dataTI['2003sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2004历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2004sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2004sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2004sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2005历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2005sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2005sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2005sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2006历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2006sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2006sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2006sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2007历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2007sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2007sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2007sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2008历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2008sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2008sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2008sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2009历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2009sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2009sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2009sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2010历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2010sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2010sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2010sum'] }
                ]
              }
            ]
          },
          {
            title: { text: '2011历年各类数据统计' },
            series: [
              ...
              {
                data: [
                  { name: '民航报文', value: dataMap.dataPI['2011sum'] },
                  { name: '常规观测资料', value: dataMap.dataSI['2011sum'] },
                  { name: '非常规观测资料', value: dataMap.dataTI['2011sum'] }
                ]
              }
            ]
          }
    ...
    handleFilter() {
      if (this.listQuery.dataType === 'cac') {
        this.tableMeta = [
          { key: 'YYGGggZ', label: '时间' },
          { key: 'CCCC', label: '机场名称' },
          { key: 'RDD', label: '跑道视程' },
          { key: 'fff', label: '风速' },
          { key: 'Td', label: '气温' },
          { key: 'QPPPP', label: '气压' },
          { key: 'ww', label: '趋势预报天气现象' }
        ]
      } else if (this.listQuery.dataType === 'msg') {
        this.tableMeta = [
          { key: 'YYGGgg', label: '时间' },
          { key: 'CCCC', label: '机场名称' },
          { key: 'fff', label: '风速' },
    ...
    handleDetails(row) {
      ...
      getMessageDetail({ id: row.id }).then(response => {
