...
var schema = [
    ...
    {name: 'AQIindex', index: 1, text: '调用数'},
    {name: 'PM25', index: 2, text: '接口1'},
    {name: 'PM10', index: 3, text: '接口2'},
    {name: 'CO', index: 4, text: '接口3'},
    {name: 'NO2', index: 5, text: '接口4'},
    {name: 'SO2', index: 6, text: '接口5'}
];
